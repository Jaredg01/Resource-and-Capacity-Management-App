/* ---------------------------------------------------------
   ...
   ---------------------------------------------------------
   PURPOSE:
   • Acts as the default renderer for the @modal parallel
     route segment when no modal is active.

   HOW IT WORKS:
   • Next.js injects a `modal` component into the layout only
     when a modal route (Add Initiative, Edit Initiative) is active.
   ...
   • Ensures the layout always returns a valid React node.
